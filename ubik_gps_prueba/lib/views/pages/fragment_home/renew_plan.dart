...
class _RenewPlanState extends State<RenewPlan>{
  ...
  RenovarPlan(List<GetRenewPlan> data, String token, String type, http.Client client){
    Widget renew;
    for(var i in data){
      renew  = Card(
        elevation: 5,
            ...
            Padding(
              ...
              child: Expanded(
                  ...
                  child: Column(children: [
                    Text(
                        "Estimado ${i.name}, su servicio esta disponible hasta el 15/05/2022",
                        softWrap: true,
                                ...
                                function: (){
                                  showDialog(
                                      ...
                                      builder: (context) => AlertDialog(
                                        ...
                                        content: FutureBuilder<List<GetRenewPlan>>(
                                            future: apiRenew.dataRenew(client, token),
                          ...
                          showDialog(
                              ...
                              builder: (context) => AlertDialog(
                                ...
                                content: FutureBuilder<List<Assesor>>(
                                    future: apiAssesor.asesorUser(client, type, token),
              ...
              child:Column(
                ...
                children: [
                  FutureBuilder(
                      ...
                      builder: (ctx, snapshot){
                        if(snapshot.hasData){
                          return RenovarPlan(snapshot.data, widget.token, asesor, http.Client());
                        }else if(snapshot.hasError){
                          return infoCargaRenewAll();
                        }
                        return infoCargaRenewAll();
                      }
                  ),
