...
>>>>>>> 1d4bf42f06c44f9ba9989754458cb0f0a37f91cf
  ...
  Future<void> _getCurrentLocation(http.Client client) async {
  ...
  Future<void> sendCommand(http.Client client, int device, String imei, String command)async{
    ...
    if(statusCommand == true){
      ...
      ToastContext().init(context);
      Toast.show("Ah ocurrido algo. Intente en breves momentos.", gravity: Toast.bottom, duration: Toast.lengthLong);
      print(statusCommand);
    }
  }
