...
class LoginState extends State<Login> {
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const Flexible(
                            flex: 1,
                            child: ButtonWidget(
                              function: null, //Navigator.push(context, MaterialPageRoute(builder: (context)=> const Register()));,
                              height: 10,
                              width: 5,
                              circular: 15,
  ...
  logIn() async {
    ...
    if (_email.isEmpty && _password.isEmpty) {
      ...
      loginSucces = await connectLogin.logIn(http.Client(), _email, _password);
      if (loginSucces == true) {
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => SplashPage(email: _email, password: _password)));
