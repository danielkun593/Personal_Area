...
class _HomeState extends State<Home> {
  ...
  infoUser (List<Usuario> data){
    Widget cardInformation;
    for(var i in data){
      cardInformation = Text("Bienvenido ${i.name}, \ntiene ${i.notifications} notificaciones pendientes",
  ...
  Stream<void> _getAddressPosition(Position position) async* {
  ...
  Stream<void> _getCurrentLocation() async* {
                    ...
                    child: Padding(
                      ...
                      child: Center(
                        child: Expanded(
                          flex: 1,
                          child: FutureBuilder(
                              future: login.dataUserHome(http.Client(), widget.email, widget.password),
                              builder: (ctx, snapshot){
                                if(snapshot.hasData){
                                  return infoUser(snapshot.data);
                                }
                    ...
                    Flexible(
                      ...
                      child: Card(
                        ...
                        child: InkWell(
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                Expanded(
                                  flex: 2,
                                  child: Image.asset('images/reports_ubik.png',),
                                ),
                                const Expanded(
                                    flex: 1,
                                    child: Text('REPORTES',
                          ...
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => ReportsData(token: widget.token, name: "GABRIEL MERIZALDE")));
                          },
                        ),
                      ),
                    ),
