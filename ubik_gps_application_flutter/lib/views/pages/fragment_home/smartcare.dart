                  ...
                  SizedBox(
                    ...
                    child: Card(
                      ...
                      child: Padding(
                          ...
                          child: Column(
                            children: [
                              const Text('ASESORIA JURIDICA EN SINIESTRO',
                                softWrap: true,
                              ...
                              Row(
                                children: [
                                  ...
                                  Flexible(
                                      ...
                                      child: Column(
                                          children: [
                                            const Text('Contactese rapidamente con nosotros, dar al boton',
                                            softWrap: true,
                                            textAlign: TextAlign.center,
                                                ...
                                                setState((){
                                                  showDialog(
                                                      ...
                                                      builder: (context) => AlertDialog(
                                                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15)),
                                                        title: const Text("ASESORIA JURIDICA EN SINIESTRO",
                                                            textAlign: TextAlign.center,
                                                  ...
                                                  content: SizedBox(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        ...
                                                        const SizedBox(height: 10),
                                                        const Text(
                                                            "Dependiendo de su necesidad, elige el servicio que sea mas conveniente",
                                                            softWrap: true,
                                                            style: TextStyle(color: Colors.grey))
                                                      ],
                                                    ),
                              ...
                              Row(
                                children: [
                                  ...
                                  Flexible(
                                      ...
                                      fit: FlexFit.tight,
                                      child: Column(children: [
                                        const Text('Puedes encontrar todo en nuestro taller',
                                            softWrap: true,
                                            textAlign: TextAlign.center,
                                            style: TextStyle(fontSize: 18, color: Colors.grey)),
                                        const SizedBox(height: 20),
