...
class OpenDevice extends StatefulWidget{
  const OpenDevice({Key key}) : super(key: key);

  @override
  _OpenDeviceState createState()=> _OpenDeviceState();
}

class _OpenDeviceState extends State<OpenDevice>{
  String deviceOpen;
  List deviceItemOpen = ['343'];
  ...
  Widget build(BuildContext context){
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text("APERTURA VEHICULO"),
                          ...
                          children: [
                            Container(
                              ...
                              child: DropdownButton(
                                ...
                                items: deviceItemOpen.map((valueItem){
                            ...
                            Row(
                                ...
                                children: [
                                  ElevatedButton(
                                    onPressed: (){
                                      String command_type = "";
                                      String deviceSelect = deviceOpen;
